...
지금은 3인 팀 졸업작품의 서버 한 대를 맡아 2026년 5월부터 상시로 굴리고 있는데, 새 기능을 만드는 시간보다 터진 걸 고치는 시간이 더 많습니다.
...
2026년 1학기 대구대학교 RISE 연계 SW종합설계에서 팀 차트 정복단(4조) 3인이 시작한 개인 투자자용 주식 퀀트 분석 플랫폼입니다.
계획서의 출발점은 시장은 실시간으로 바뀌는데 분석은 과거 데이터에 머문다는 문제였습니다.
팀장 이민성이 데이터 파이프라인, 임창혁이 대시보드·시각화, 제가 클라우드·인프라를 맡았습니다.
Kafka 서버 구축은 이민성과 나눠 맡았고, DB 서버와 클라우드 배포는 제 몫이었습니다.
과목이 끝난 2026-06-09 뒤로는 모은 신호가 실제로 맞는지 재는 판정 원장을 제가 따로 만들었고, 서버 운영도 이어 가고 있습니다.
2026-09-11 에 이 작품으로 팀이 대구대학교 AI·SW 캡스톤디자인 공모전 우수상을 받았습니다([결과 공지](https://aisw.daegu.ac.kr/article/notice25/detail/225770)).
...
과목이 끝난 뒤 판정 원장에 모아 보니 국내주식 판정칸 231개 중 통제 최소선을 넘은 게 21칸이었습니다. 다중비교 보정을 통과한 8칸은 전부 코스피보다 못한 쪽이었고, 비용을 빼고도 양수인 칸은 0이었습니다.
...
* 라벨링을 사람이 하면 못 끝낸다고 보고 LLM 에게 맡겼습니다
...
백업은 있는지보다 맞는 것을 넣었는지를 봐야 한다는 걸 여기서 배웠습니다.
...
* 대구대학교 AI·SW 캡스톤디자인 공모전 우수상 (2026학년도 2학기, 팀 차트 정복단, 졸업작품 CHRONO, 작품명 크로노AI)
