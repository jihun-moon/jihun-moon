...
Kafka·DB 서버와 Docker 배포, 신호 검증 체계를 제가 맡았고, 과목이 끝난 뒤에도 서버 운영을 이어 가고 있습니다.
2026-09-11 에 이 작품으로 대구대학교 AI·SW 캡스톤디자인 공모전 우수상을 받았습니다.
...
* 대구대학교 AI·SW 캡스톤디자인 공모전 우수상 (2026학년도 2학기, 팀 차트 정복단, 졸업작품 CHRONO)
